 ...
 */
#ifndef V1_COM_QUALCOMM_QTI_TELEPHONY_INFO_SVC_SOMEIP_STUB_ADAPTER_HPP_
#define V1_COM_QUALCOMM_QTI_TELEPHONY_INFO_SVC_SOMEIP_STUB_ADAPTER_HPP_

#include <InfoSvc/v1/com/qualcomm/qti/telephony/InfoSvcStub.hpp>
...
template <typename _Stub = ::v1::com::qualcomm::qti::telephony::InfoSvcStub, typename... _Stubs>
...
public:
    ...
    CommonAPI::SomeIP::GetAttributeStubDispatcher<
        ::v1::com::qualcomm::qti::telephony::InfoSvcStub,
        CommonAPI::Version
    ...
    CommonAPI::SomeIP::MethodWithReplyStubDispatcher<
        ::v1::com::qualcomm::qti::telephony::InfoSvcStub,
        std::tuple< >,
        std::tuple< std::string, InfoSvcTypes::TelephonyResultT>,
        std::tuple< >,
        std::tuple< CommonAPI::SomeIP::StringDeployment, ::v1::com::qualcomm::qti::telephony::InfoSvcTypes_::TelephonyResultTDeployment_t>
    ...
    InfoSvcSomeIPStubAdapterInternal(
        ...
        getImeiStubDispatcher(
            ...
            _stub->hasElement(0),
            std::make_tuple(),
            std::make_tuple(static_cast< CommonAPI::SomeIP::StringDeployment* >(nullptr), static_cast< ::v1::com::qualcomm::qti::telephony::InfoSvcTypes_::TelephonyResultTDeployment_t* >(nullptr)))

    {
        InfoSvcSomeIPStubAdapterHelper::addStubDispatcher( { CommonAPI::SomeIP::method_id_t(0x1f5) }, &getImeiStubDispatcher );
...
#endif // V1_COM_QUALCOMM_QTI_TELEPHONY_Info_Svc_SOMEIP_STUB_ADAPTER_HPP_
