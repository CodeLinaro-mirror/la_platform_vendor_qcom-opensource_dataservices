...
*/
#ifndef V1_COM_QUALCOMM_QTI_TELEPHONY_Info_Svc_STUB_DEFAULT_HPP_
#define V1_COM_QUALCOMM_QTI_TELEPHONY_Info_Svc_STUB_DEFAULT_HPP_
...
public:
    ...
    COMMONAPI_EXPORT virtual void GetImei(const std::shared_ptr<CommonAPI::ClientId> _client, GetImeiReply_t _reply) {
        (void)_client;
        std::string imei = "";
        InfoSvcTypes::TelephonyResultT result = InfoSvcTypes::TelephonyResultT::TELEPHONY_RESULT_T_UNKNOWN;
        if (!result.validate()) {
            return;
        }
        _reply(imei, result);
...
#endif // V1_COM_QUALCOMM_QTI_TELEPHONY_Info_Svc_STUB_DEFAULT
