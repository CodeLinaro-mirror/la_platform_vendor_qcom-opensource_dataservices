...
*/
#ifndef V1_COM_QUALCOMM_QTI_TELEPHONY_Info_Svc_STUB_HPP_
#define V1_COM_QUALCOMM_QTI_TELEPHONY_Info_Svc_STUB_HPP_
...
{
public:
    typedef std::function<void (std::string _imei, InfoSvcTypes::TelephonyResultT _result)> GetImeiReply_t;
...
#endif // V1_COM_QUALCOMM_QTI_TELEPHONY_Info_Svc_STUB_HPP_
