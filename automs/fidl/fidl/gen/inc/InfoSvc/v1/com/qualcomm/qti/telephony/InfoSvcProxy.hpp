...
*/
#ifndef V1_COM_QUALCOMM_QTI_TELEPHONY_Info_Svc_PROXY_HPP_
#define V1_COM_QUALCOMM_QTI_TELEPHONY_Info_Svc_PROXY_HPP_

#include <InfoSvc/v1/com/qualcomm/qti/telephony/InfoSvcProxyBase.hpp>
...
public:
     ...
     * will be set.
     */
    virtual void GetImei(CommonAPI::CallStatus &_internalCallStatus, std::string &_imei, InfoSvcTypes::TelephonyResultT &_result, const CommonAPI::CallInfo *_info = nullptr);
    /**
...
template <typename ... _AttributeExtensions>
void InfoSvcProxy<_AttributeExtensions...>::GetImei(CommonAPI::CallStatus &_internalCallStatus, std::string &_imei, InfoSvcTypes::TelephonyResultT &_result, const CommonAPI::CallInfo *_info) {
    delegate_->GetImei(_internalCallStatus, _imei, _result, _info);
}
...
#endif // V1_COM_QUALCOMM_QTI_TELEPHONY_Info_Svc_PROXY_HPP_
